...
export const changelog: ChangelogEntry[] = [
  {
    ...
    fixed: ['修正 lastLoginTime cookie登录的保存和获取逻辑'],
  },
  {
    ...
    fixed: ['修正 lastLoginTime 的保存和获取逻辑'],
  },
  {
  ...
  },
  {
    ...
    fixed: [
      '修复构建错误',
      '未使用变量清理 - 为所有未使用的变量添加了下划线前缀',
      '类型安全改进 - 将所有 any 类型替换为更具体的 unknown 类型',
    ],
  },
  {
    version: '2025.09.22.01',
    date: '2025-09-22',
    added: ['新增弹幕获取播放'],
    changed: [
      // 无变更内容
